...
//   // Add this new component just before the return statement of your BlochSphere component
...
//           The Bloch sphere is a geometric representation of pure quantum states
//           of a two-level system (qubit). The north pole typically represents the
//           |0⟩ state and the south pole represents the |1⟩ state.
//         </p>
//       </div>

//       <div style={{ marginBottom: "16px" }}>
//         <h4 style={{ color: "#4c6cff", marginBottom: "8px" }}>Key Concepts</h4>
//         <ul
//           style={{
//             paddingLeft: "20px",
//             lineHeight: "1.6",
...
//         >
//           <li>
//             <strong>θ (Theta):</strong> Angle from the vertical Z-axis (0 to π)
//           </li>
//           <li>
//             <strong>φ (Phi):</strong> Angle in the X-Y plane (0 to 2π)
//           </li>
//           <li>
//             <strong>Basis States:</strong> |0⟩, |1⟩, |+⟩, |-⟩, |i⟩, -|i⟩
//           </li>
//           <li>
//             <strong>Vector:</strong> Represents the quantum state's
//             superposition
//           </li>
//         </ul>
//       </div>
...
//           }}
//         >
//           <li>Drag to rotate the sphere view</li>
//           <li>Scroll to zoom in/out</li>
//           <li>Adjust θ and φ sliders to change the quantum state</li>
...
//               <span style={{ color: "#ffc300" }}>θ (theta):</span> {theta.toFixed(2)} rad
//               <input
//                 type="range"
//                 min={0}
//                 max={Math.PI}
...
//             <label style={{ display: "block", marginBottom: 8 }}>
//               <span style={{ color: "#ffc300" }}>φ (phi):</span> {phi.toFixed(2)} rad
//               <input
//                 type="range"
//                 min={0}
//                 max={Math.PI * 2}
...
//                 { theta: Math.PI / 2, phi: Math.PI, label: "|-⟩", color: "#ff4c4c" },
//                 { theta: Math.PI / 2, phi: Math.PI / 2, label: "|i⟩", color: "#4c6cff" },
//                 { theta: Math.PI / 2, phi: (3 * Math.PI) / 2, label: "-|i⟩", color: "#4c6cff" },
//               ].map((state) => (
//                 <button
//                   key={state.label}
//                   style={{
//                     ...(isActive(state.theta, state.phi) ? buttonActiveStyle : buttonStyle,
...
//         {/* Right Column - Educational Notes */}
//         <div style={{
//           flex: 1,
//           padding: "16px",
...
//             <h4 style={{ color: "#4c6cff", marginBottom: "8px" }}>Quantum State Representation</h4>
//             <p style={{ lineHeight: "1.6", color: "#ddd" }}>
//               The Bloch sphere visually represents the quantum state of a qubit as a point on a unit sphere.
//               The north pole is |0⟩, south pole is |1⟩, and all other points are superpositions.
//             </p>
//             <div style={{
...
//           <div style={{ marginBottom: "24px" }}>
//             <h4 style={{ color: "#4c6cff", marginBottom: "8px" }}>Key Parameters</h4>
//             <ul style={{ paddingLeft: "20px", color: "#ddd", lineHeight: "1.8" }}>
//               <li><strong>θ (Theta):</strong> Polar angle (0 to π) - Determines probability amplitudes</li>
//               <li><strong>φ (Phi):</strong> Azimuthal angle (0 to 2π) - Determines relative phase</li>
//               <li><strong>Basis States:</strong> |0⟩, |1⟩ (computational), |+⟩, |-⟩ (Hadamard), |i⟩, -|i⟩ (circular)</li>
//             </ul>
//           </div>

//           <div style={{ marginBottom: "24px" }}>
//             <h4 style={{ color: "#4c6cff", marginBottom: "8px" }}>Visualization Features</h4>
//             <ul style={{ paddingLeft: "20px", color: "#ddd", lineHeight: "1.8" }}>
//               <li><strong>Gold Vector:</strong> Current quantum state</li>
//               <li><strong>Blue Sphere:</strong> All possible pure states</li>
//               <li><strong>Colored Axes:</strong> X (red), Y (green), Z (blue) measurement bases</li>
//               <li><strong>Equator:</strong> States with equal |0⟩ and |1⟩ probabilities</li>
//             </ul>
//           </div>

//           <div>
//             <h4 style={{ color: "#4c6cff", marginBottom: "8px" }}>Interactivity Guide</h4>
//             <ul style={{ paddingLeft: "20px", color: "#ddd", lineHeight: "1.8" }}>
...
//         fontSize: "14px",
//       }}>
//         Drag to rotate the sphere. Scroll to zoom. Use sliders or click a basis state.
//       </div>
//     </div>
//   );
// };
