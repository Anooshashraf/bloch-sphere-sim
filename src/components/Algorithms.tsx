...
//     // }
//     // router.push(
//     //   `/results?data=${encodeURIComponent(JSON.stringify(wrappedResult))}`
//     // );
//     // optional local state if Circuit wants to preview its own results
//     // setLastRun(wrappedResult);
//     // setShowResultsPanel(true);
//     const encoded = encodeURIComponent(JSON.stringify(wrappedResult));
//     router.push(`/results?data=${encoded}`);

//     // optional: still call onResults for local preview/debugging
//     if (onResults) {
//       try {
//         onResults(wrappedResult);
//       } catch (e) {
...
//         <h2 className="text-xl text-[#ffc300] font-bold">Algorithms</h2>
//         {/* Example button to run circuit */}
//         <button
//           onClick={runCircuit}
//           className="px-4 py-2 rounded bg-[#ffc300] text-black font-semibold hover:bg-yellow-500"
//         >
//           Run Circuit
//         </button>
//       </div>
