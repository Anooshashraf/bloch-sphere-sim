            ...
            <div className="mt-6 bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="mt-6 p-4 bg-indigo-50 rounded-md">
                ...
                <ul className="list-disc pl-5 text-sm text-indigo-700 space-y-1">
                  <li>Drag on the sphere to rotate the view</li>
                  <li>
                    Click and drag on the sphere surface to change the quantum
                    state
                  </li>
                  <li>
                    Use the sliders to precisely control theta and phi angles
                  </li>
                  <li>The red arrow represents the quantum state vector</li>
                </ul>
              </div>
            </div>
          </div>
